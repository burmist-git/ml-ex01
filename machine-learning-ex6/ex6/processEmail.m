function word_indices = processEmail(email_contents, buildingVocabulary)
...
% Load Vocabulary
if(buildingVocabulary == false)
  [vocabList wordCounter] = getVocabList('vocab.txt',1);
else
  vocListFile = 'vocabMy.txt';
